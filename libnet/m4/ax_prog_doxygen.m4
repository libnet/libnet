...
# This file (ax_prog_doxygen.m4) has been slightly modified for use with libnet.
# Namely, it does NOT create yet another separate Doxygen output directory 
# but instead puts all generated files in the already existing "doc" directory.
# Line no. 557 has been modified to make this possible.
# Keep this in mind if you ever want to update this file.
#
# ===========================================================================
...
AC_ARG_VAR(DOXYGEN_PAPER_SIZE,
           [a4 (default), a4wide, letter, legal or executive])
case "$DOXYGEN_PAPER_SIZE" in
#(
"")
    AC_SUBST(DOXYGEN_PAPER_SIZE, "")
;; #(
a4|a4wide|letter|legal|executive)
...
[[\$(DX_DOCDIR]DX_i[)/\$(PACKAGE).tag: \$(DX_CONFIG]DX_i[) \$(pkginclude_HEADERS)
	\$(A""M_V_at)touch -c \$(DX_DOCDIR]DX_i[)
